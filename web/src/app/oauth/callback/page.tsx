...
export default function OAuthCallbackPage() {
  ...
  return (
    <div className="auth-page grid h-dvh w-full place-items-center px-4 py-6">
      <div className="yan-panel-strong flex w-full max-w-sm flex-col items-center rounded-2xl px-8 py-10 text-center">
        <div className="yan-mark-gradient grid size-14 place-items-center rounded-[22px] text-white shadow-[0_18px_42px_rgba(15,23,42,0.18)]">
          <LoaderCircle className="size-5 animate-spin" />
        </div>
        <div className="mt-5 text-[11px] font-semibold uppercase tracking-[0.24em] text-[#2563eb]">OAuth callback</div>
